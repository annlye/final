    ...
    <div id="content" style="height: 50%;width: 100%;">
        ...
        <div id="main" style="margin-left: 18%;margin-top: 1%">
            <div id="main1" style="float: left;text-align: center;margin-right: 1%">
               <a href="MAC.jsp"> <img src="img/MAC.jpg" width="250px" height="250px"><p>MAC魅可 子弹头口红<br>￥139 </p></a>
            </div>
            <div id="main2" style="float: left;text-align: center;margin-right: 1%">
                <a href="Dior.jsp"><img src="img/Dior.jpg" width="250px" height="250px"><p>Dior迪奥口红<br>￥269</p></a>
            </div>
            <div id="main3" style="float: left;text-align: center;margin-right: 1%">
                <a href="TF.jsp"><img src="img/TF.jpg" width="250px" height="250px"><p>汤姆福特新品细管口红润唇膏<br>¥329.00</p></a>
            </div>
            <div id="main4" style="float: left;text-align: center">
                <a href="tz.jsp"><img src="img/tz.jpg" width="250px" height="250px"><p>透真气色唇膏<br>¥49.90</p></a>
            </div>
        </div>
    </div>
    <br>
    ...
    <h3 style="text-align: center">|护肤套装|</h3>
        <div id="main0" style="margin-left: 18%;margin-top: 1%">
            <div id="main01" style="float: left;text-align: center;margin-right: 1%">
                <a href="AHC.jsp"><img src="img/AHC.jpg" width="250px" height="250px"><p>A.H.C 玻尿酸神仙水水乳套盒<br>￥129</p></a>
            </div>
            <div id="main02" style="float: left;text-align: center;margin-right: 1%">
                <a href="PE.jsp"><img src="img/PE.jpg" width="250px" height="250px"><p>百雀羚(PECHOIN)水嫩倍现臻美套装 <br>￥249</p></a>
            </div>
            <div id="main03" style="float: left;text-align: center;margin-right: 1%">
               <a href="LO.jsp"><img src="img/LO.jpg" width="250px" height="250px"><p>欧莱雅复颜抗皱紧致护肤化妆品套装<br>￥349</p></a>
            </div>
            <div id="main04" style="float: left;text-align: center;margin-right: 1%">
                <a href="in.jsp"><img src="img/in.jpg" width="250px" height="250px"><p>悦诗风吟 绿茶精萃平衡保湿水乳两件套装 <br>￥128</p></a>
            </div>
        </div>
    </div>
</div>
<div class="box" id="box1" style="bottom:50%;left:0;">
    <img src="img/in1.jpg" width=100>
</div>
